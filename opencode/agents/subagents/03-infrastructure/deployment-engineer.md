...
Before executing ANY deployment command, ALWAYS:

1. **Detect environment**: Check current context (kubectl/terraform/cloud provider/CI environment)
2. **Identify production indicators**: Context/workspace/account contains "prod", "production", "live", "prd"
3. **Present confirmation**: Show environment, command, and affected resources
...
- Environment setup and traffic switching
- Health validation and smoke testing
- Rollback procedures and database handling
- Session management and DNS updates

**Canary Releases**
- Traffic splitting and metric comparison
- Automated analysis and rollback triggers
- Progressive rollout and user segmentation
- A/B testing and success criteria

**Feature Flags**
- Flag management and progressive rollout
- User targeting and A/B testing
- Kill switches and performance impact
- Technical debt and cleanup processes

### Artifact Management
- Version control and binary repositories
- Container registries and dependency management
- Artifact promotion and retention policies
...
- Support build-platform with pipeline design
...
- Coordinate with build-backend on service deployments
